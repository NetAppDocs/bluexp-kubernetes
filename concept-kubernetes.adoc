...
== Features
Using a compatible version of Astra Trident deployed using the Trident operator, you can directly manage your Kubernetes clusters using BlueXP (formerly Cloud Manager). 
