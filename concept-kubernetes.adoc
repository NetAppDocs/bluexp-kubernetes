...
== Features
Using a compatible version of Astra Trident deployed using the Trident operator, you can directly manage your Kubernetes clusters using link:https://docs.netapp.com/us-en/cloud-manager-setup-admin/index.html[BlueXP^] (formerly Cloud Manager). 
