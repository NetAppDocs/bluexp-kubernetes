...
== Features
Using a link:https://docs.netapp.com/us-en/cloud-manager-setup-admin/index.html[BlueXP^] (formerly Cloud Manager) and a compatible version of Astra Trident deployed using the Trident operator, you can:  
...
* link:./task/task-kubernetes-enable-services.html[Activate or view Cloud Backup]
