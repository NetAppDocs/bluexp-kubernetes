...
[.lead]
Learn what's new in Kubernetes in BlueXP (Cloud Manager).
...
* link:https://docs.netapp.com/us-en/cloud-manager-kubernetes/task/task-kubernetes-discover-openshift.html[Import an OpenShift cluster to Cloud Manager]
